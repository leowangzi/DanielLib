...
namespace DanielLib.Utilities.StringHandler
{
    public static class StringTools
    {
        ...
        {
            //如果为空，认为验证合格
            if (StrArrayHandler.IsNullOrEmpty(ip))
            {
                return true;
            }
        ...
        {
            //如果为空，认为验证不合格
            if (StrArrayHandler.IsNullOrEmpty(email))
            {
                return false;
            }
        ...
        {
            //如果为空，认为验证不合格
            if (StrArrayHandler.IsNullOrEmpty(number))
            {
                return false;
            }
        ...
        {
            //如果为空，认为验证合格
            if (StrArrayHandler.IsNullOrEmpty(date))
            {
                return true;
            }
        ...
        {
            //如果为空，认为验证合格
            if (StrArrayHandler.IsNullOrEmpty(idCard))
            {
                return true;
            }
